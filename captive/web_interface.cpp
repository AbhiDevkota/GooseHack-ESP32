...
// Variable definitions moved from web_interface.h
String targetSSID = "";
int targetChannel = 0;
...
// Function definitions moved from web_interface.h
...
void setupWebServer() {
  ...
  webServer.on("/combined", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/sourapple", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/windowsbt", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/connectnet", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/printer", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/scanprinters", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/printtest", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/aggressive", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/viewhandshakes", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/clearhs", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/download", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/beaconspam", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/custombeacon", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/viewpass", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/clearpass", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
  ...
  webServer.on("/changeap", HTTP_POST, []() {
    if (evilActive || combinedActive) {
      webServer.send(HTTP_CODE, "text/html", evilIndex());
      return;
    }
